...
import { buildChatCatalog, getRoomDisplayName, getTimelineMessages, type TimelineMessage } from './chatCatalog';
...
export async function buildRoomSnapshot(
  ...
  return {
    ...
    roomSubtitle: chat?.nativeSpaceName || `${room.getJoinedMemberCount()} members`,
